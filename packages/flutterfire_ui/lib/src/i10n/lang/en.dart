...
class EnLocalizations extends FlutterFireUILocalizationLabels {
  ...
  const EnLocalizations({
    ...
    this.smsAutoresolutionFailedError = 'Failed to resolve SMS code automatically. Please enter your code manually',
    ...
    this.accessDisabledErrorText = 'Access to this account has been temporarily disabled',
    this.wrongOrNoPasswordErrorText = 'The password is invalid or the user does not have a password',
    ...
    this.differentMethodsSignInTitleText = 'Use one of the following methods to sign in',
    ...
    this.forgotPasswordHintText = 'Provide your email and we will send you a link to reset your password',
